...
ALL_DEXES = [MAIN_DEX, "xyz", "flx", "hyna", "km"]
...
@dataclass
class Position:
    """Position data from Hyperliquid API"""
    address: str
    token: str
    side: str
    size: float
...
def fetch_all_positions(
    ...
    for i, (address, cohort) in enumerate(addresses):
        ...
        positions_with_exchange = fetch_all_positions_for_address(address, dexes)
